 ...
 */
public class AwtRobotScreenshotAdapter implements ScreenshotService {

    private static final Logger LOGGER = LoggerFactory.getLogger(AwtRobotScreenshotAdapter.class);
     ...
     */
    public AwtRobotScreenshotAdapter() throws AWTException {
     ...
     */
    public AwtRobotScreenshotAdapter(Robot robot, GraphicsDevice graphicsDevice) {
        this.robot = robot;
